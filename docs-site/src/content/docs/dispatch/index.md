...
:::note[지금 상태]
**설계 중 (2026-06-18 시작).** 큰 방향과 4가지 결정은 끝났고(아래 6번), "배가 언제 떠나는지"(출항·작업완료 예정 시각)도 어디 있는지 찾았습니다. 아직 만들기 전 단계. 처음에는 **실제로 트럭을 보내지 않고, 추천만 화면에 띄워** 맞는지 확인한 뒤에 실제 적용합니다.
:::
...
**어떻게:**
1. "배가 작업 끝내야 할 시각까지 남은 시간"을 그 배의 남은 작업들에 나눠 → **작업마다 마감 시간**.
