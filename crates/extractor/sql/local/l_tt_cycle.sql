-- Local parity for K_TT_CYCLE / K_CYCLE(shift) (Oracle original: sql/c10_k_tt_cycle.sql).
-- Same filter (machno ^C[0-9]+$, jobtype LD/DS, trk_id not null), same 120..1200s cap,
