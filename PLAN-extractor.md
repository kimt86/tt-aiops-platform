...
**K_EMPTY 병산 대조** — 재료 `tos_handover_label.un_trv_rng` 가 2026-08-06 16:40 KST 부터
쌓인다. **2026-08-07 이후** 하루치가 차면 어제 하루를 양쪽으로 재계산해 대조하라(명령은
`~/.claude/notes/tt-aiops-platform.md` "절체 안전망" 절). 그 전 창이 행 0 인 것은 정상이다.
