...
## RESULT — 2026-08-21 17:50 KST 확정 (pool_ver 5 · 11:25 KST 배포 · 6h15m)
...
- **프룬은 아직 한 번도 지운 적이 없다**(두 표의 최초 행이 08-19, 보관 3일). `db.rs` RETENTION 에 등록해
  조용히 no-op 하면 경보가 뜨게 해뒀지만, **실제 삭제 동작은 08-22 이후에야 검증된다.**
